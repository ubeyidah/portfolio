...
export const post = getBlogPosts().find((item) => item.slug === "learning-by-building");

<BlogPostLayout
	title={post?.title ?? "The Best Way to Learn Programming Is When You Actually Need It"}
