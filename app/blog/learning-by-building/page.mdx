...
export const canonicalUrl = "https://ubeyidah.tech/blog/learning-by-building";
...
export const metadata = {
	...
	openGraph: {
		...
		images: [
			{
				url: "https://miro.medium.com/v2/resize:fit:640/format:webp/0*1ZDU7eEksPkMvjmp",
				width: 1200,
				height: 630,
	...
	twitter: {
		...
		description:
			"Why building real projects creates the fastest feedback loop and the most durable skills.",
		images: ["https://miro.medium.com/v2/resize:fit:640/format:webp/0*1ZDU7eEksPkMvjmp"],
	},
};
